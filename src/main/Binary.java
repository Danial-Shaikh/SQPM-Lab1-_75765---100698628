...
public class Binary {
    ...
    public static Binary and(Binary num1, Binary num2) {
        ...
        // Perform's bitwise AND operations digit by digit
        while (ind1 >= 0 || ind2 >= 0) {
            int bit1 = (ind1 >= 0) ? (num1.number.charAt(ind1) - '0') : 0;
            int bit2 = (ind2 >= 0) ? (num2.number.charAt(ind2) - '0') : 0;
            //convert the AND-result to string// and append it to result.
            result = ((bit1 & bit2) == 1 ? "1" : "0") + result;
            ind1--;
            ind2--;
        }
    ...
    public static Binary or(Binary num1, Binary num2) {
        int ind1 = num1.number.length() - 1;
        int ind2 = num2.number.length() - 1;
        String result = "";  // binary value of the OR result

        // Perform's bitwise OR operations digit by digit
        while (ind1 >= 0 || ind2 >= 0) {
            int bit1 = (ind1 >= 0) ? (num1.number.charAt(ind1) - '0') : 0;
            int bit2 = (ind2 >= 0) ? (num2.number.charAt(ind2) - '0') : 0;
            //convert OR-result to string and append it to result.
            result = ((bit1 | bit2) == 1 ? "1" : "0") + result;
            ind1--;
            ind2--;
        }
    ...
    public static Binary multiply(Binary num1, Binary num2) {
        ...
        // Loops through each of the multiplicand bit from right to left
